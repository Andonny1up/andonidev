    ...
    <section className='pb-40 pt-20'>
      ...
      <div className='max-w-3xl'>
        ...
        <div className='flex flex-wrap gap-4'>
          ...
          <a href='https://drive.google.com/file/d/1DjqTkOeHbMsHXvXJyVq2eqmfj_Zg9cIQ/view?usp=sharing' target='_blank' rel='noopener noreferrer' className='px-6 py-3 border border-gray-300 text-gray-700 dark:border-slate-700 dark:text-slate-200 font-semibold rounded-lg hover:bg-gray-50 dark:hover:bg-slate-800 transition-colors'>
